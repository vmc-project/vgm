...
class GDMLWriter : public virtual IWriter
{
 public:
  GDMLWriter(
    const std::string& unitName = "unit1", const std::string& version = "1.0");
  virtual ~GDMLWriter();
  ...
  virtual void WriteSolid(
    std::string lvName, const VGM::ISolid* solid, std::string /*mediumName*/);
 ...
 private:
  ...
  // Writing solids
  //
  void WriteBooleanSolid(std::string name, const VGM::IBooleanSolid* solid);
  void WriteBox(std::string lvName, double hx, double hy, double hz);
  ...
  void WriteEllipsoid(std::string name, const VGM::IEllipsoid* ellipsoid);
...
inline double XmlVGM::GDMLWriter::LengthUnit() const { return 10.; } // cm

inline double XmlVGM::GDMLWriter::AngleUnit() const { return 1.; } // deg
...
inline void XmlVGM::GDMLWriter::SetNumWidth(int width) { fNW = width; }
...
inline double XmlVGM::GDMLWriter::GetNumWidth() const { return fNW; }

inline double XmlVGM::GDMLWriter::GetNumPrecision() const { return fNP; }
